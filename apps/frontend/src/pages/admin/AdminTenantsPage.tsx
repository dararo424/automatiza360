    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <input
          ...
          className="bg-slate-800 text-white px-4 py-2 rounded-lg border border-slate-600 focus:outline-none focus:border-indigo-500 flex-1 min-w-48"
        />
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="bg-slate-800 text-white px-4 py-2 rounded-lg border border-slate-600 focus:outline-none"
        >
