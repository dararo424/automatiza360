      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        {waLink && (
          <div className="text-center py-4">
            ...
            {perfil.whatsappNumber && (
              <div className="text-center mt-4">
                <p className="text-slate-500 text-xs mb-2">Escanea para escribirnos por WhatsApp</p>
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(`https://wa.me/${perfil.whatsappNumber?.replace(/\D/g, '')}`)}`}
                  alt="WhatsApp QR"
        ...
        {perfil.latitud != null && perfil.longitud != null && (
          <div>
            <iframe
              src={`https://www.openstreetmap.org/export/embed.html?bbox=${perfil.longitud - 0.01},${perfil.latitud - 0.01},${perfil.longitud + 0.01},${perfil.latitud + 0.01}&layer=mapnik&marker=${perfil.latitud},${perfil.longitud}`}
              width="100%"
              height="250"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block mt-2 text-center bg-green-600 hover:bg-green-500 text-white py-2 rounded-xl text-sm font-semibold"
            >
              Cómo llegar
            </a>
          </div>
